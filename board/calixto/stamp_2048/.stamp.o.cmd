cmd_board/calixto/stamp/stamp.o := /opt/arm-toolchain/arm-gnu-toolchain-11.3.rel1-x86_64-aarch64-none-linux-gnu/bin/aarch64-none-linux-gnu-gcc -Wp,-MD,board/calixto/stamp/.stamp.o.d -nostdinc -isystem /opt/arm-toolchain/arm-gnu-toolchain-11.3.rel1-x86_64-aarch64-none-linux-gnu/bin/../lib/gcc/aarch64-none-linux-gnu/11.3.1/include -Iinclude    -I./arch/arm/include -include ./include/linux/kconfig.h -I./dts/upstream/include  -D__KERNEL__ -D__UBOOT__ -Wall -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -std=gnu11 -fshort-wchar -fno-strict-aliasing -fno-PIE -Os -DLTO_ENABLE -flto=4 -fno-stack-protector -fno-delete-null-pointer-checks -Wno-pointer-sign -Wno-stringop-truncation -Wno-zero-length-bounds -Wno-array-bounds -Wno-stringop-overflow -Wno-maybe-uninitialized -fmacro-prefix-map=./= -gdwarf-4 -fstack-usage -Wno-format-nonliteral -Wno-address-of-packed-member -Wno-unused-but-set-variable -Werror=date-time -Wno-packed-not-aligned -D__ARM__ -fno-pic -mstrict-align -ffunction-sections -fdata-sections -fno-common -ffixed-x18 -mgeneral-regs-only -mbranch-protection=none -pipe -march=armv8-a+crc -D__LINUX_ARM_ARCH__=8 -I./arch/arm/mach-k3/include    -DKBUILD_BASENAME='"stamp"'  -DKBUILD_MODNAME='"stamp"' -c -o board/calixto/stamp/stamp.o board/calixto/stamp/stamp.c

source_board/calixto/stamp/stamp.o := board/calixto/stamp/stamp.c

deps_board/calixto/stamp/stamp.o := \
  ...
  arch/arm/include/asm/arch/hardware.h \
    ...
    $(wildcard include/config/soc/k3/am62l3.h) \
    $(wildcard include/config/soc/k3/am62p5.h) \
    ...
    $(wildcard include/config/soc/k3/j722s.h) \
  ...
  /opt/arm-toolchain/arm-gnu-toolchain-11.3.rel1-x86_64-aarch64-none-linux-gnu/lib/gcc/aarch64-none-linux-gnu/11.3.1/include/stdbool.h \
  ...
  /opt/arm-toolchain/arm-gnu-toolchain-11.3.rel1-x86_64-aarch64-none-linux-gnu/lib/gcc/aarch64-none-linux-gnu/11.3.1/include/stdarg.h \
  ...
  arch/arm/include/asm/arch/am62l_hardware.h \
  include/config.h \
  ...
  include/compiler.h \
  /opt/arm-toolchain/arm-gnu-toolchain-11.3.rel1-x86_64-aarch64-none-linux-gnu/lib/gcc/aarch64-none-linux-gnu/11.3.1/include/stddef.h \
  ...
  arch/arm/include/asm/arch/am62l_spl.h \
  include/handoff.h \
  include/mmc.h \
  ...
  board/calixto/stamp/../common/fdt_ops.h \
    $(wildcard include/config/default/fdt/file.h) \
    $(wildcard include/config/default/device/tree.h) \

board/calixto/stamp/stamp.o: $(deps_board/calixto/stamp/stamp.o)
