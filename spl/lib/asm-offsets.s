	.arch armv8-a+crc
	.file	"asm-offsets.c"
// GNU C11 (Arm GNU Toolchain 13.3.Rel1 (Build arm-13.24)) version 13.3.1 20240614 (aarch64-none-linux-gnu)
...
.ascii "->GENERATED_GBL_DATA_SIZE 336 (sizeof(struct global_data) + 15) & ~15"	//
// 0 "" 2
...
.ascii "->GD_SIZE 328 sizeof(struct global_data)"	//
// 0 "" 2
...
.ascii "->GD_FLAGS 48 offsetof(struct global_data, flags)"	//
// 0 "" 2
	.loc 1 36 2 view .LVU6
// 36 "lib/asm-offsets.c" 1
	
.ascii "->GD_MALLOC_BASE 312 offsetof(struct global_data, malloc_base)"	//
// 0 "" 2
	.loc 1 39 2 view .LVU7
// 39 "lib/asm-offsets.c" 1
	
.ascii "->GD_RELOCADDR 80 offsetof(struct global_data, relocaddr)"	//
// 0 "" 2
	.loc 1 41 2 view .LVU8
// 41 "lib/asm-offsets.c" 1
	
.ascii "->GD_RELOC_OFF 104 offsetof(struct global_data, reloc_off)"	//
// 0 "" 2
	.loc 1 43 2 view .LVU9
// 43 "lib/asm-offsets.c" 1
	
.ascii "->GD_START_ADDR_SP 96 offsetof(struct global_data, start_addr_sp)"	//
// 0 "" 2
...
.LASF11:
	...
	.string	"a+crc -mlittle-endian -mabi=lp64 -gdwarf-4 -Os -std=gnu11 -fno-builtin -ffreestanding -fshort-wchar -fno-strict-aliasing -fno-PIE -fno-delete-null-pointer-checks -fstack-usage -ffunction-sections -fdata-sections -fno-stack-protector -fno-common -ffixed-x18"
.LASF9:
	.string	"long long unsigned int"
.LASF13:
	.string	"/home/calixto/BSP/am62l/anandhu_sources/ti-u-boot"
.LASF7:
